...
During this project my responsibility was to make a dynamic view inside a maze using the **raycasting algorithm**, based on a 2D grid map file.

My teammates responsibility was to fill the shapes using textures, after which we both worked on player events
