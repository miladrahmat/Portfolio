...
The goal of this project is to learn how a UNIX shell works in a deeper level, how to parse input and execute shell commands in a seperate process in C

### What I did

During this project my responsibility was to implement a few **UNIX signal interpretations**, building the supported **built-in commands** and **executing shell commands**, while keeping track of **child processes** and **file descriptors**.
