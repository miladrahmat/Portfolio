const About = () => {
	return (
		<div role='About me' id='about' className='w-full h-screen bg-[#0a192f] text-gray-300'>
					...
					<div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
						...
						<div className='sm:text-2xl'>
							<p aria-label='Introduction'>
								I have recently completed my studies at <a className='inline hover:text-blue-400 underline' href='https://www.hive.fi' target='_blank' rel='noopener noreferrer'>
								Hive Helsinki</a>, where I've greatly developed my technical skills and soft skills such as collaborative problem solving and teamworking.<br /><br />
