...
const Contact = () => {
	...
	return (
		<div aria-label='Contact' id='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'> 
			<div className='flex flex-col justify-center items-center max-w-[600px] w-full'>
				<div className='pb-8 flex flex-col justify-center w-full h-full items-center'>
					<h2 className='text-2xl sm:text-4xl font-bold inline border-b-4 border-cyan-500 text-gray-300'>
						Contact
					</h2>
					<h3 className='sm:text-2xl text-gray-300 py-4'>
						Let's connect!
					</h3>
				</div>
